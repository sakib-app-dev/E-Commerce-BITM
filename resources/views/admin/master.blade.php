...
<body id="page-top">
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Sakib Ahamed 2020</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
  ...
  <script src="{{asset('public/admin/')}}/jslogin/demo/chart-area-demo.js"></script>
  <script src="{{asset('public/admin/')}}/jslogin/demo/chart-pie-demo.js"></script>
