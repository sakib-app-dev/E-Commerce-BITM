...
<div class="men-wear">
    <div class="container">
            ...
            <div class="col-md-4 product-men no-pad-men">
                <div class="men-pro-item simpleCart_shelfItem">
                    ...
                    <div class="item-info-product ">
                        <h4><a href="{{url('/product_details')}}">Watches</a></h4>
            ...
            <div class="col-md-4 product-men no-pad-men">
                <div class="men-pro-item simpleCart_shelfItem">
                    <div class="men-thumb-item">
                        ...
                        <div class="men-cart-pro">
                            <div class="inner-men-cart-pro">
                                <a href="{{url('/product_details')}}" class="link-product-add-cart">Quick View</a>
                            </div>
                        </div>
                        <span class="product-new-top">New</span>
        ...
        <div class="single-pro">
            @foreach($PublishedCategoryProducts as $published_product_by_category)

            <div class="col-md-3 product-men">
                <div class="men-pro-item simpleCart_shelfItem">
                    <div class="men-thumb-item">
                        <img src="{{asset($published_product_by_category->image)}}" alt="" class="pro-image-front">
                        <img src="{{asset($published_product_by_category->image)}}" alt="" class="pro-image-back">
                        <div class="men-cart-pro">
                            <div class="inner-men-cart-pro">
                                <a href="{{url('/product_details')}}" class="link-product-add-cart">Quick View</a>
                            </div>
                    ...
                    <div class="item-info-product ">
                        <h4><a href="{{url('/product_details')}}">{{$published_product_by_category->product_name}}</a></h4>
                        <div class="info-product-price">
                            <span class="item_price">{{$published_product_by_category->price}}</span>
                            <del>$69.71</del>
                        </div>
                        <a href="#" class="item_add single-item hvr-outline-out button2">Add to cart</a>									
                    </div>
