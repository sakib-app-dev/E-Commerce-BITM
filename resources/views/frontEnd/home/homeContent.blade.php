                        ...
                        <div class="col-md-3 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{asset($PublishedProduct->image)}}" alt="{{$PublishedProduct->image}}" class="pro-image-front">
                                    <img src="{{asset('/'.$PublishedProduct->image)}}" alt="{{$PublishedProduct->image}}" class="pro-image-back">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="{{url('/product_details/'.$PublishedProduct->id)}}" class="link-product-add-cart">Quick View</a>
                                        </div>
                                    </div>
                                ...
                                <div class="item-info-product ">
                                    <h4><a href="{{url('/product_details/'.$PublishedProduct->id)}}">{{$PublishedProduct->product_name}}</a></h4>
                                    <div class="info-product-price">
                                        <span class="item_price">BDT. {{$PublishedProduct->price}} TK</span>
