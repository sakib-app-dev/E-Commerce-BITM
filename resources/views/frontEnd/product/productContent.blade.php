...
<div class="single">
    <div class="container">
        <div class="col-md-6 single-right-left animated wow slideInUp animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: slideInUp;">
            <div class="grid images_3_of_2">
                <div class="flexslider">
                    ...
                    <!-- //FlexSlider-->
                    <ul class="slides">
                        <li data-thumb="{{asset('/'.$product_info->image)}}">
                            <div class="thumb-image"> <img src="{{asset('/'.$product_info->image)}}" data-imagezoom="true" class="img-responsive"> </div>
                        </li>
                        ...
                        <li data-thumb="{{asset('public/frontEnd/')}}/images/d4.jpg">
                            <div class="thumb-image"> <img src="{{asset('public/frontEnd/')}}/" data-imagezoom="true" class="img-responsive"> </div>
                        </li>	
                    </ul>
        ...
        <div class="col-md-6 single-right-left simpleCart_shelfItem animated wow slideInRight animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: slideInRight;">
            ...
            <p><span class="item_price">{{$product_info->price}}</span> <del>- $900</del></p>
            <div class="rating1">
